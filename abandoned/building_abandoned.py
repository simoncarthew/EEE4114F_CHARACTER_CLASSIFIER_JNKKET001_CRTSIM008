...
class CombLetterClassifier:
    ...
    def train(self,max_no_epochs, min_loss_chng,learn_rate, display=False, loss_func=nn.CrossEntropyLoss()):
        ...
        for i in range(self.num_models):
            ...
            validation_trend, training_trend, loss_trend, epochs = train_classifier(self.models[i],self.train_loaders[i],self.val_loaders[i],max_no_epochs,min_loss_chng,learn_rate,display=display,loss_func=loss_func)
            ...
            results.append([validation_trend, training_trend, loss_trend, epochs])
        return results
